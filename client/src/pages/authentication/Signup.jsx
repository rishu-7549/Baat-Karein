  ...
  return (
    <div className="flex justify-center items-center p-6 min-h-screen">
      <div className="max-w-[40rem] w-full flex flex-col gap-5 bg-base-200 p-6 rounded-lg">
        ...
        <label className="input input-error input-bordered flex items-center gap-2">
          <FaUser />
          <input
            type="text"
            name="fullName"
        ...
        <div className="input input-error input-bordered flex items-center gap-5">
        ...
        <button onClick={handleSignup} className="btn btn-error">
          Signup
        </button>
